    ...
    <div className={styles.page}>
      <div className="container">
        ...
        <div className={styles.header}>
          ...
          <Link to="/fields" className="btn btn-primary btn-sm">+ Đặt sân mới</Link>
        </div>
        ...
        {loading ? (
          ...
          <div className={styles.empty}>
            ...
            <Link to="/fields" className="btn btn-primary btn-sm">Đặt sân ngay</Link>
          </div>
        ) : (
