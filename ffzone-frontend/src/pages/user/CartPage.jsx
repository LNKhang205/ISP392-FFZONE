...
export default function CartPage() {
  ...
  if (loading) return <div className={styles.page}><div className="container"><p>⏳ Đang tải giỏ hàng...</p></div></div>
                ...
                <div key={item.id} className={styles.item}>
                  ...
                  <div className={styles.info}>
                    ...
                    <div className={styles.cat}>{
                      item.serviceCategory === 'DRINK' ? '🥤 Đồ uống'
                      : item.serviceCategory === 'EQUIPMENT' ? '⚽ Dụng cụ'
                      : '🏟️ Tiện ích'
                    }</div>
